...
/**
 * Form di creazione di un docente (solo SEGRETERIA). Crea anche l'account di
 * login: per questo serve la password. Le regole sulla password sono validate
 * dal backend, che ne restituisce gli errori in italiano.
 */
export function CreateTeacherPage() {
  ...
  return (
    <div className="mx-auto max-w-lg">
      <h1 className="mb-4 text-2xl font-bold text-slate-800">Nuovo docente</h1>
      ...
      >
        ...
        <div className="flex flex-col gap-1">
          ...
          <input
            ...
            placeholder="Es. mario.rossi@unibs.it"
            required
          />
        </div>
